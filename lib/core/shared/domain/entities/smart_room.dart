...
class SmartRoom {
  ...
  static List<SmartRoom> fakeValues = [
    _room,
    _room.copyWith(id: '2', name: 'SALA DE JANTAR', imageUrl: _imagesUrls[2]),
    _room.copyWith(id: '3', name: 'COZINHA', imageUrl: _imagesUrls[3]),
    _room.copyWith(id: '4', name: 'QUARTO', imageUrl: _imagesUrls[4]),
    _room.copyWith(id: '5', name: 'BANHEIRO', imageUrl: _imagesUrls[1]),
  ];
}
